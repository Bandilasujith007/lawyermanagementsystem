...
<!--header-->
<div class="header"  >
	<!-- <div class="top-header" style="background-color: #244065;" >
		<div class="container" style="background-color: #244065;"> -->
		<div class="top-head" style="background-color: #244065;">
			<ul class="header-in">
...
<!--        <p>Choose your genre to find Category titles here!</p>-->
        ...
        $sql = "SELECT * FROM lawyer where case_handle= 'family lawyer'";
