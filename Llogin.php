		...
		<section class="registerform">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
					<img src="login.png">
						<form action="loginbk.php" method="POST"  id="validateForm">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" name="password" id="passord" placeholder=" Password">
							</div>

							<input type="submit" class="btn btn-block btn-success" value="Login"  style=" background-color: #244065; border-color:#244065;"
/><br>
							<!--after signup redirect user dashboard page-->
							<a href="lawyer_register.php" style="color:black;"><p>signup</p></a>
						</form>
					</div>
				</div>
			</div>
