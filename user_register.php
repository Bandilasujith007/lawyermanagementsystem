		...
		<section class="registerform">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<form action="user_registerbk.php" method="POST" enctype="multipart/form-data" id="validateForm">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" name="password" id="contact_number" placeholder="Password">
							</div>
							<div class="form-group">
							...
							<input name="post" type="submit" class="btn btn-block btn-success" value="Register"  style=" background-color: #244065; border-color:#244065;" />
